		...
		<div class="header-top">
			...
			if($_GET && $_GET['action']=='publish' && $_GET['uid']==$_rows['mb_id']){
				...
				// if(isset($_id)){
					...
					// $_query=mysql_query("select mb_article_id, mb_uid, mb_article_title, mb_article_content, mb_article_time from mb_article where mb_article_id='{$_id}' order by mb_article_time desc");
					$_query=mysql_query("select mb_article_id, mb_uid, mb_article_title, mb_article_content, mb_article_time from mb_article limit 5 order by mb_article_time desc ");
